...
import com.metaphorce.exam.ecommerce.mappers.impl.UserMapper;
...
public class UserController
{
     ...
     */
    @GetMapping
    @PreAuthorize("hasAnyRole('VENDOR','BUYER')")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('VENDOR','BUYER')")
    public ResponseEntity<UserResponse> getUserById(@NotBlank @PathVariable Long id) {
